      ...
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
            <h2 className="font-bold text-2xl lg:text-3xl text-white mb-5">Maulana</h2>
            <h3 className="font-bold text-2xl lg:text-3xl mb-2">Contact Me</h3>
            <p>maulanafikriash@gmail.com</p>
            <br />
            <p>Jl.Ujung Harapan, Kel. Bahagia, Kec. Babelan</p>
            <p>Bekasi Utara, Jawa Barat. Indonesia</p>
          </div>
        </div>
